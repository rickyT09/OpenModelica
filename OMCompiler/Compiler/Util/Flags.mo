...
constant ConfigFlag POST_OPT_MODULES = CONFIG_FLAG(16, "postOptModules",
  NONE(), EXTERNAL(), STRING_LIST_FLAG({
    ...
    "fixupDifferentiatedDelayIndices",
    "findZeroCrossings",
  ...
  SOME(STRING_DESC_OPTION({
    ...
    ("fixupDifferentiatedDelayIndices", Gettext.gettext("Fixes delay expression indices set to -1 by differentiation. See GitHub issue #15532.")),
